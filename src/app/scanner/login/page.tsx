    ...
    <div className="min-h-screen bg-black flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Registration Team Access</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-4 bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md">
          {error && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/50 border border-white/10 rounded-2xl pl-12 pr-4 py-4 text-white focus:outline-none focus:border-poster-accent transition-colors placeholder:text-slate-600"
                placeholder="••••••••"
                required
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-poster-accent text-poster-bg hover:bg-poster-accent-bright font-bold py-4 rounded-2xl transition-all disabled:opacity-70 flex items-center justify-center gap-2 group mt-6"
          >
            {loading ? (
